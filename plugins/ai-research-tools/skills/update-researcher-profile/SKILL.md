...
description: "Use this skill when the user invokes $update-researcher-profile, /update-researcher-profile, asks to run update-researcher-profile, or asks to sync the researcher profile from idea files. This is the Codex adapter for the canonical AI Research Tools Claude command."
---
# update-researcher-profile

<!-- workflow-adapter: {"generator_version":"1.0.0","schema":"ai-research-tools.codex-skill-adapter","schema_version":1,"source_path":"packages/idea-pipeline/commands/update-researcher-profile.md","source_sha256":"168fd83e2f1bd323fa33e495c17d4878de56af147cffcb901b70ddde43ae827a","workflow_version":"3.0.0"} -->

## Trigger Forms

- $update-researcher-profile
- /update-researcher-profile
- Natural language requests to rebuild and sync the researcher profile from idea files

## Codex Execution Rules

- Do **not** read `~/.claude/commands/update-researcher-profile.md` at runtime; the canonical Claude command is embedded below.
