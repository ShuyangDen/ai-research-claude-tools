---
name: idea-next
description: "Use this skill when the user invokes $idea-next, /idea-next, asks to run idea-next, or asks to advance an idea to the next pipeline stage. This is the Codex adapter for the canonical AI Research Tools Claude command."
---
# idea-next

<!-- workflow-adapter: {"generator_version":"1.0.0","schema":"ai-research-tools.codex-skill-adapter","schema_version":1,"source_path":"packages/idea-pipeline/commands/idea-next.md","source_sha256":"ff1fe87a0d87cc4ff6d8797163de8c874604f102442a89fb22990dd37bced336","workflow_version":"3.4.0"} -->

## Trigger Forms

- $idea-next
- /idea-next
- Natural language requests to advance an idea to its next pipeline stage

## Codex Execution Rules

- Do **not** read `~/.claude/commands/idea-next.md` at runtime; the canonical Claude command is embedded below.
