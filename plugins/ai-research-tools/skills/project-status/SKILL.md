---
name: project-status
description: "Use this skill when the user invokes $project-status, /project-status, asks to run project-status, or asks to discuss or inspect a tracked research project. This is the Codex adapter for the canonical AI Research Tools Claude command."
---
# project-status

<!-- workflow-adapter: {"generator_version":"1.0.0","schema":"ai-research-tools.codex-skill-adapter","schema_version":1,"source_path":"packages/idea-pipeline/commands/project-status.md","source_sha256":"f329b778d6b3ca7448a45df91fd6f6a14c5f7b78f74b7b36d2ad740fcbcac038","workflow_version":"3.0.0"} -->
...
- Do **not** read `~/.claude/commands/project-status.md` at runtime; the canonical Claude command is embedded below.
