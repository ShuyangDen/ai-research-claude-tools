---
name: paper-done
description: Use this skill when the user invokes $paper-done, /paper-done, says a paper reading is complete, or asks to export notes and run the post-session paper pipeline. This is the Codex-native copy of the AI Research Tools workflow; do not read Claude command files at runtime.
---
# paper-done
