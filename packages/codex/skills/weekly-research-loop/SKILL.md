...
description: "Use this skill when the researcher wants to run the weekly research cycle from Gmail digest or Paper Tracker queue through bounded reading, cluster synthesis, personalized idea generation, review, and memory updates. It should trigger for requests to finish the weekly paper workflow and ask what ideas AI would generate in the researcher's style."
---
# weekly-research-loop

<!-- workflow-adapter: {"generator_version":"1.0.0","schema":"ai-research-tools.codex-skill-adapter","schema_version":1,"source_path":"packages/idea-pipeline/commands/weekly-research-loop.md","source_sha256":"caa6653b1469baccfead579031f6324d4e649423304bf68d29681d171d0730ef","workflow_version":"3.4.0"} -->

## Trigger Forms

- $weekly-research-loop
- /weekly-research-loop
- Natural language requests to connect this week's paper digest, reading queue, research memory, and personalized idea generation

## Codex Execution Rules

- Do **not** read `~/.claude/commands/weekly-research-loop.md` at runtime; the canonical Claude command is embedded below.
