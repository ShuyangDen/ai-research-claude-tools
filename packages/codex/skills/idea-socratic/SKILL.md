---
name: idea-socratic
description: Use this skill when the user invokes $idea-socratic, /idea-socratic, or asks to refine a research idea through Socratic dialogue. This is the Codex-native copy of the AI Research Tools workflow; do not read Claude command files at runtime.
---
# idea-socratic
